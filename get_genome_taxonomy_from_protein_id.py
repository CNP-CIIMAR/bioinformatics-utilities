...
# Verifique se os argumentos necessÃƒÂ¡rios foram fornecidos
if len(sys.argv) < 4:
        ...
        if protein_accession:
            ...
            try:
                ...
                for line in ipg_result.split('\n'):
                    if 'RefSeq' in line:
                        refseq_info = line.split()[-1]  # Presume-se que o ID desejado esteja na ÃƒÂºltima coluna
                    elif 'INSDC' in line:
...
# Prepara a tabela taxonÃƒÂ´mica usando a saÃƒÂ­da do passo anterior
data = []
