...
#### Pedro Leao - Team Leader - CNP- Team
import re
import sys
import os
import logging
...
leandro.pereira@marfim:/investgenomicaarea/Leandro/Metagenomica/Analogos/KEGG_2020/KEGG_2020cp$ head -10000 AnEnPi.A.createFastaECv2.py
...
leandro.pereira@marfim:/investgenomicaarea/Leandro/Metagenomica/Analogos/KEGG_2020/KEGG_2020cp$ ls
AnEnPi.A.createFastaEcs.py  AnEnPi.A.createFastaECv2.py  Batchjob_lmp  Batchjob_lmp.o138864  clusterBulk.py  clusterBulkv2.py  clusterpackage.py  count_files.fasta  genes.all.kegg-2020.pep  __init__.py  Result
leandro.pereira@marfim:/investgenomicaarea/Leandro/Metagenomica/Analogos/KEGG_2020/KEGG_2020cp$ head -1000 clusterBulk.py
