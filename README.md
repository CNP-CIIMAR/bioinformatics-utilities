...
# Script 15: dbscan_analysis_graph_heatmap.py Overview Results Run_DBCAN4 Heatmap Generator
...
- Saves count tables in tab-separated values (TSV) format for further analysis with collums: Subfamily       contagem        Specie (the name of species should be in the name overview file in the following format as in the example: overview_output_Anabaena_aphanizomenioides_LEGE_00250.txt)
