...
Run the script using the following command:
 ...
 ```shell
python proteinsearchhmm.py [MODELS_DIR] [FASTAS_DIR]
 ```
...
Assuming you have a directory models/ containing .hmm files and a directory fastas/ containing .faa files
 ```shell
python proteinsearchhmm.py models/ fastas/
 ```
##Supported Formats
